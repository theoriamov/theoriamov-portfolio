/* Textos editados direto na página (modo de edição). Valem por cima do dados.js. */
const TEXTOS = {
  "servicosLinha": "Vídeos para empresas, eventos e gastronomia e produções feitas com inteligência artificial.",
  "gancho": "DESCUBRA COMO",
